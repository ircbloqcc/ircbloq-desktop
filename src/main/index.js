...
import telemetry from './IrcbloqDesktopTelemetry';
import Updater from './IrcbloqDesktopUpdater';
import DesktopLink from './IrcbloqDesktopLink.js';
...
import locales from 'ircbloq-l10n/locales/desktop-msgs';
...
const displayPermissionDeniedWarning = (browserWindow, permissionType) => {
    ...
    case 'camera':
        ...
        message = formatMessage({
            ...
            default: 'Permission to use the camera has been denied. ' +
                'IrcBloq will not be able to take a photo or use video sensing blocks.',
    ...
    case 'microphone':
        ...
        message = formatMessage({
            ...
            default: 'Permission to use the microphone has been denied. ' +
                    'IrcBloq will not be able to record sounds or detect loudness.',
    ...
    case 'darwin':
        instructions = formatMessage({
            ...
            default: 'To change IrcBloq permissions, please check "Security & Privacy" in System Preferences.',
    ...
    default:
        instructions = formatMessage({
            ...
            default: 'To change IrcBloq permissions, please check your system settings and restart IrcBloq.',
    ...
    webContents.on('will-prevent-unload', ev => {
        const choice = dialog.showMessageBoxSync(window, {
            ...
            message: formatMessage({
                ...
                default: 'Leave Ircbloq?',
                description: 'prompt for leave Ircbloq'
            }),
            detail: formatMessage({
                id: 'index.questionLeaveDetail',
                default: 'Any unsaved changes will be lost.',
                description: 'detail prompt for leave Ircbloq'
            }),
            buttons: [
                formatMessage({
                    id: 'index.stay',
